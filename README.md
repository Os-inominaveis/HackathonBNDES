...
│                               needed
├── condaenv.yml            <- Conda environment definition for ensuring consistent setup across environments
├── LICENSE
...
│
├── data
│   ├── interim[desc]       <- Interim files - give these folders whatever name makes sense.
